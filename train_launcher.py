...
if __name__ == '__main__':
	...
	# training 
	model = HourglassModel(nFeat=params['nfeats'], nStack=params['nstacks'], nLow=params['nlow'], outputDim=params['output_dim'], batch_size=params['batch_size'], training=True, drop_rate= params['dropout_rate'], lear_rate=params['learning_rate'], decay=params['learning_rate_decay'], decay_step=params['decay_step'], dataset=dataset, logdir_train=params['log_dir_train'], logdir_test=params['log_dir_test'], model_dir=params['model_dir'], w_loss=params['weighted_loss'], name=params['name'], gpu=params['gpu'])
